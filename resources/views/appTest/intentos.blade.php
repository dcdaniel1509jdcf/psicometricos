...
<h6><i class="icon fas fa-info"></i> {{ session('message') }} !</h6>
                ...
                <div class="card">
                    <div class="card-header h3">{{ __('Administracion de Intentos de Usuarios') }}</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" id="divtipo">
                            ...
                            <div class="form-group">
                                ...
                                <select name="estudiantes" class="form-control" id="estudiantes" required>
                                ...
                                <select name="tipo" class="form-control" id="tipo" required>
                                    ...
                                    <option value="Perfil Emprededor">Perfil Emprededor</option>
                        ...
                        <div class="col-md-3" id="divactivar">
                            ...
                            <br>
                            <button type="button" id="btnGuardar" onclick="return confirm('Desea Continuar')"
                                    class="btn btn-danger">Activar a Todos</button>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $("#btnGuardar").click(function() {
                ...
                if ($("#colegios").val() != "" && $("#cursos").val() != "") {
                    ...
                    $('#alTodos').html('<div class="alert alert-success alert-dismissible">'+
                        '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>'+
                        '<h5><i class="icon fas fa-info"></i> Activaciones Exitosa</h5>'+
                        '</div>');
