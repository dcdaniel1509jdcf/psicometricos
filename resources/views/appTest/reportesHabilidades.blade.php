    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header h3">{{ __('Descarga de Reportes, Habilidades') }}</div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#cursos").change(function() {
                ...
                $("#divactivar").show()
                $('#divactivar').html("<a class='btn btn-danger' href='/reporteTodos2/todos/?idCol="+$("#colegios").val()+"&idCur="+$("#cursos").val()+"'>Descargar Curso </a>");
            ...
            $("#btnGuardar").click(function() {
                ...
                if ($("#colegios").val() != "" && $("#cursos").val() != "") {
                    ...
                    $.get(base_url + "/reporteTodos2/todos/", {
                        idCol: $("#colegios").val(),
                        idCur: $("#cursos").val(),
